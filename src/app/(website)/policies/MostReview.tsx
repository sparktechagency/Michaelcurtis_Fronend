            ...
            <MaxWidth>
                <div className=' flex flex-row items-center justify-between gap-x-24 ' >
                    ...
                    <div className=' max-w-[70%] flex-1 w-full ' >
                        ...
                        <div>
                            <button className=' lg:mt-6 mt-3  lg:text-2xl text-lg font-normal text-white flex items-center gap-x-3 -ml-6 lg:ml-0 ' >
                                Explore {singleProvider?.provider?.name} Reviews
                                <Link href={`/insurance-profile/${singleProvider?.provider?.slug}`} ><span className=' block mt-1  ' ><svg width="27" height="21" viewBox="0 0 27 21" fill="none" xmlns="http://www.w3.org/2000/svg">
