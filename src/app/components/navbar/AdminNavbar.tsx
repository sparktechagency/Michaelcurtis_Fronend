...
const AdminNavbar = () => {
    ...
    // const { data: notification } = useDashboardNotificationQuery({});
    ...
    const { data: unread } = useUnreadNotificationQuery({});
    ...
    return (
        <nav className="w-full bg-[#FAF5EC]  px-6 py-4 flex items-center justify-between sticky top-0 z-50">
            ...
            <div className="flex items-center space-x-6 relative">
                {/* Notification Icon */}
                <Link className=" cursor-pointer " href={`/admin/notifications`}>
                            ...
                            <ul className="py-2 text-gray-700">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <p onClick={handleLogout} className="text-[#D93A3A] font-medium text-sm" >
                                            Logout
                                        </p>
                                    </button>
                                </li>
