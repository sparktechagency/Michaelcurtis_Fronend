...
const Banner = () => {
    ...
    const handleSearch = () => {
        ...
        const sanitizedValue = trimmed.replace(/\s+/g, '');
                ...
                <div className='mx-auto'>
                    <div className='flex flex-col lg:flex-row gap-x-20 items-start lg:space-y-0 space-y-10'>
                        ...
                        <div className='w-full lg:max-w-[55%] mx-auto'>
                            <div>
                                <h1 className='text-[#4C545F] font-bold lg:text-[55px] text-3xl'>
                                    Transparent Insurance Reviews,
                                    <span className='text-[#D09A40]'>Powered by the Community</span>
                                </h1>
                        ...
                        <div className='w-full lg:max-w-[45%] mx-auto'>
                            <Image
                                src={"/images/home/banner/banner-image.png"}
                                width={1500}
                                height={1500}
                                alt='banner'
